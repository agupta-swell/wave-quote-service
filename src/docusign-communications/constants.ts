...
export const DOCUSIGN_TEMPLATE_IDS_BY_ENV: Record<DocuSignEnv, IDocusignTemplateMapping> = {
  dev: {
    CA_CONSUMER_GUIDE: '0',
    CONTRACT_ONE: '0',
    SOLAR_ENERGY_DISCLOSURE_ESA: '0',
    DISCLOSURES_ESA: '0',
    ADDITIONAL_TERMS_ESA: '0',
    SWELL_SERVICE_ESA_X1: '0',
    LIMITED_WARRANTIES_ESA_X2: '0',
    CUSTOMER_OBLIGATIONS_X3: '0',
    ARBITRATION_X4: '0',
    NOTICE_OF_CANCELLATION_X5: '0',
    CA_NOTICE_AND_DISC_X6: '0',
    SYSTEM_DESIGN_NOTICE_X8: '0',
    INSURANCE_X9: '0',
    AUTOMATIC_PAYMENT_AUTHORIZATION_FORM_FIN: '0',
    PARTICIPATION_PRP2_ACES_CASH: '0',
    CA_CONSUMER_PROTECTION: '0',
    PARTICIPATION_PRP2_ACES_ESA: '0',
    SOLAR_ENERGY_SYSTEM_ESTIMATED_X7: '0',
    GRID_SERVICES_AGT: '0',
    HOME_ENERGY_SUB_AGT_ESA: '0',
    PAYMENT_SCHEDULE_X10: '0',
    DUMMY_CHANGE_ORDER: '0',
    DUMMY_PRIMARY_CONTRACT: 'c11ddf5e-734e-4d62-92a3-084c5d40e7ad',
  },
  demo: {
