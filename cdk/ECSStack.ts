    ...
    const loadBalancedFargateService = new ApplicationLoadBalancedFargateService(this, 'Service', {
      ...
      taskImageOptions: {
        ...
        secrets: {
          ...
          DOCUSIGN_ESA_ACCOUNT_ID: sec.fromSecretsManager(secret, 'DOCUSIGN_ESA_ACCOUNT_ID'),
          ...
          USE_GOOGLE_SOLAR: sec.fromSecretsManager(secret, 'USE_GOOGLE_SOLAR'),
          GOOGLE_SOLAR_API_KEY: sec.fromSecretsManager(secret, 'GOOGLE_SOLAR_API_KEY'),
